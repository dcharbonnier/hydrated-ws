...
case "${SAUCE_CONNECT_PLATFORM}" in
    linux)
        ...
        SC_DISTRIBUTION_SHASUM=dc0210fbc99a609f01c1a50a9fb6e77c2293cfd8;;
    osx)
        SC_DISTRIBUTION_FMT=zip
        SC_DISTRIBUTION_SHASUM=d02832aa7879ee44722d6f65a7c7730696a41d09;;
esac
SC_DISTRIBUTION=sc-4.4.10-${SAUCE_CONNECT_PLATFORM}.${SC_DISTRIBUTION_FMT}
